...
router.use('/suppliers', checkToken, SupplierRouter);
router.use('/contacts', checkToken, ContactRouter);
router.use('/info', checkToken, GeminiRouter);
router.use('/mail', checkToken, MailRouter);
